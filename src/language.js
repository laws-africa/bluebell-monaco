...
export const LANGUAGE_DEF = {
  defaultToken: '',
  hier: /ALINEA|ARTICLE|BOOK|CHAPTER|CLAUSE|DIVISION|INDENT|LEVEL|LIST|PARAGRAPH|PART|POINT|PROVISO|RULE|SECTION|SUBCHAPTER|SUBCLAUSE|SUBDIVISION|SUBLIST|SUBPARAGRAPH|SUBPART|SUBRULE|SUBSECTION|SUBTITLE|TITLE|TOME|TRANSITIONAL/,
  blocks: /QUOTE/,
